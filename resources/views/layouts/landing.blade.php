                    ...
                    <div class="header-right">
                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <a href="{{route("Shopcart")}}"><span class="lable">Cart</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Nest" src="{{asset('assets/landing/imgs/shop/thumbnail-2.jpg')}}" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
...
>>>>>>> a24bdf2794f50196608e2de44948e0f5556da275
                    <a href="index.html"><img src="{{asset('assets/landing/imgs/theme/logo.svg')}}" alt="logo" /></a>
                </div>
